...
import tp005_cernik_alex.Entidades.Asistente;
import tp005_cernik_alex.Entidades.Cama;
import tp005_cernik_alex.Entidades.Especialidad;
import tp005_cernik_alex.Entidades.Paciente;
import tp005_cernik_alex.Entidades.Profesional;
import tp005_cernik_alex.Entidades.Recurso;
import tp005_cernik_alex.Entidades.Televisor;
import tp005_cernik_alex.Entidades.Turno;
...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Creo los asistentes 
        Asistente asistente1 = new Asistente(1, "Velez", "Norma", new Date(1980, 05,12));
        Asistente asistente2 = new Asistente(1, "Ronaldo", "Jose", new Date(1970, 01, 01));
        
        //==Creo los profesionales
        Profesional p1 = new Profesional(0, "GODOY", "HECTOR", new Date(),
                        1000221, new TreeMap<Integer,Especialidad>());
        
        Profesional p2 = new Profesional(1, "ALVAREZ", "PEDRO", new Date(),
                        30100221, new TreeMap<Integer,Especialidad>());
        
        //==Agrego Turno a p1
        Paciente paciente1 = new Paciente(505, "FERNANDEZ", "AGOSTINA", new Date(),
        ...
        //==Agrego Turno a p2
        Paciente paciente2 = new Paciente(8001, "GONZALES", "PEDRO", new Date(),
        ...
        Paciente paciente3 = new Paciente(7001, "ALTAMIRADA", "JUANA", new Date(),
